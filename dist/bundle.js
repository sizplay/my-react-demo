...
var _ThingCreate = __webpack_require__(84);

var _ThingCreate2 = _interopRequireDefault(_ThingCreate);
...
var _Thing = __webpack_require__(105);
...
var App = function (_Component) {
  ...
  function App() {
    ...
    _this.onCreateThing = _this.onCreateThing.bind(_this);
    _this.onUpdateThing = _this.onUpdateThing.bind(_this);
    _this.onDestroyThing = _this.onDestroyThing.bind(_this);
    return _this;
  }
  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      ...
      _axios2.default.get('/api/things').then(function (result) {
        return result.data;
      }).then(function (things) {
        return _this2.setState({ things: things });
      });
    }
  }, {
    key: 'onUpdateThing',
    value: function onUpdateThing(thing) {
      var _this3 = this;

      _axios2.default.put('/api/things/' + thing.id, thing).then(function (result) {
        return result.data;
      }).then(function (thing) {
        var things = _this3.state.things.map(function (_thing) {
          return _thing.id === thing.id * 1 ? thing : _thing;
        });
        _this3.setState({ things: things });
        document.location.hash = '/';
      });
    }
  }, {
    key: 'onCreateThing',
    value: function onCreateThing(thing) {
      var _this4 = this;

      _axios2.default.post('/api/things', thing).then(function (result) {
        return result.data;
      }).then(function (thing) {
        return _this4.setState({ things: [].concat(_toConsumableArray(_this4.state.things), [thing]) });
      }) //need to ask
      .then(function () {
    ...
    key: 'onDestroyThing',
    value: function onDestroyThing(id) {
      var _this5 = this;

      _axios2.default.delete('/api/things/' + id).then(function (result) {
        return result.data;
      }).then(function () {
        var things = _this5.state.things.filter(function (_thing) {
          return _thing.id !== id * 1;
        });
        _this5.setState({ things: things });
        document.location.hash = '/';
      });
    }
  }, {
    ...
    value: function render() {
      ...
      var onCreateThing = this.onCreateThing,
          onUpdateThing = this.onUpdateThing,
          onDestroyThing = this.onDestroyThing;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_reactRouterDom.Route, { render: function render(_ref) {
              ...
              return _react2.default.createElement(_Nav2.default, { path: location.pathname, thingsCount: things.length });
            } }),
          _react2.default.createElement(
            _reactRouterDom.Switch,
            null,
            _react2.default.createElement(_reactRouterDom.Route, { path: '/', exact: true, render: function render() {
                return _react2.default.createElement(_Things2.default, { things: things });
              } }),
            _react2.default.createElement(_reactRouterDom.Route, { path: '/things/create', exact: true, render: function render() {
                return _react2.default.createElement(_ThingCreate2.default, { onCreateThing: onCreateThing });
              } }),
            _react2.default.createElement(_reactRouterDom.Route, { path: '/things/:id', exact: true, render: function render(_ref2) {
...
var ThingCreate = function (_Component) {
  _inherits(ThingCreate, _Component);

  function ThingCreate() {
    _classCallCheck(this, ThingCreate);

    var _this = _possibleConstructorReturn(this, (ThingCreate.__proto__ || Object.getPrototypeOf(ThingCreate)).call(this));
...
var Nav = function Nav(_ref) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'li',
      null,
      path === '/things/create' ? _react2.default.createElement(
        'span',
        null,
        'Create'
      ) : _react2.default.createElement(
...
var Thing = function (_Component) {
  ...
  function Thing() {
    ...
    _this.onChange = _this.onChange.bind(_this);
    _this.setThing = _this.setThing.bind(_this);
  ...
  _createClass(Thing, [{
    key: 'setThing',
    value: function setThing(things, id) {
      var thing = things.find(function (thing) {
        return thing.id === id;
      });
      if (thing) {
        //if no thing then null
